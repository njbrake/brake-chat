...
usage() {
    ...
    echo "  $0 --webui[port=3000] --playwright"
    echo "  $0 --webui[port=3000] --playwright --build"
    echo ""
    echo "This script configures and runs a docker-compose setup with optional Playwright support and web UI configuration."
}
