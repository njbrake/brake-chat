...
class MessageReplyToResponse(MessageUserResponse):
    reply_to_message: MessageUserResponse | None = None
...
class MessageTable:
    def insert_new_message(self, form_data: MessageForm, channel_id: str, user_id: str) -> MessageModel | None:
        with get_db() as db:
            id = str(uuid.uuid4())
    ...
    def get_message_by_id(self, id: str) -> MessageResponse | None:
        with get_db() as db:
    ...
    def update_message_by_id(self, id: str, form_data: MessageForm) -> MessageModel | None:
        with get_db() as db:
            message = db.get(Message, id)
    ...
    def add_reaction_to_message(self, id: str, user_id: str, name: str) -> MessageReactionModel | None:
        with get_db() as db:
