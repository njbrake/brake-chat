...
import { userSignIn, userSignUp, ldapUserSignIn, getSessionUser, getBackendConfig } from '@/lib/api/auths';
                  ...
                  <form className="flex flex-col justify-center" onSubmit={submitHandler}>
                    ...
                    {(config?.features?.enable_login_form || config?.features?.enable_ldap) && (
                      <div className="flex flex-col mt-4">
                        ...
                        {mode === 'ldap' ? (
                          <div className="mb-2">
                            <label htmlFor="username" className="text-sm font-medium text-left mb-1 block">
                              Username
                            </label>
                            <input
                              value={ldapUsername}
